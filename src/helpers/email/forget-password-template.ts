export interface ForgetPasswordEmailTemplateParams {
  displayName: string;
  code: string;
}

/**
 * Generates a responsive HTML email template for password reset verification code.
 ...
 * - Border color: #dfccc1
 */
export const getForgetPasswordEmailTemplate = (displayName: string, code: string): string => {
  return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
        ...
        <table role="presentation" class="email-container" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 560px; margin: 0 auto; padding: 20px;">
                ...
                <tr>
                  <td class="card-body" style="padding: 36px 32px;">
                    ...
                    <p style="color: #9c8c87; font-size: 13px; line-height: 1.5;">
                      For security reasons, please do not share this verification code with anyone. If you didn't request a password reset, you can safely ignore this email.
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td align="center" style="padding-top: 24px; color: #9c8c87; font-size: 12px; line-height: 1.5;">
              <p style="margin-bottom: 4px;">If you did not request a password reset, please ignore this email.</p>
...
export default getForgetPasswordEmailTemplate;
